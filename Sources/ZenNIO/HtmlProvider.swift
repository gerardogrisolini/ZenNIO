...
//  
//
//  Created by Gerardo Grisolini on 23/11/2019.
//
...
struct HtmlProvider : HtmlProtocol {
...
html = `
    <form>
        ...
        <br/><input class="fadeIn third" type="password" id="password" placeholder="password"/>
        <br/><input class="fadeIn fourth" type="button" value="Sign In" onclick="signIn()"/>
    </form>
`;
    } else {
html = `
